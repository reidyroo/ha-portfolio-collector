#!/usr/bin/env python3
"""
Portfolio Collector — Home Assistant Add-on v2.9.5
===================================================
...
app = FastAPI(title="Portfolio Collector", version="2.9.5")
...
if __name__ == "__main__":
    ...
    log.info(
    f"Portfolio Collector v2.9.5 — phase={cfg['portfolio_phase']} — "
