#!/usr/bin/env python3
"""
Portfolio Collector — Home Assistant Add-on v3.0.3
===================================================
...
app = FastAPI(title="Portfolio Collector", version="3.0.3")
...
if __name__ == "__main__":
    ...
    log.info(
    f"Portfolio Collector v3.0.3 — phase={cfg['portfolio_phase']} — "
